...
function numberPlayer() {
    ...
    if (Number.isNaN(parseInt(playerChoice)) || playerChoice < 1 || playerChoice > 1000) {
...
function checkNumber() {
    ...
    if (playerChoice > aleatoryNumber) {
        ...
        var infoDiv = document.getElementById('infoGame');
        infoDiv.innerHTML = '<h5>Você acertou! O número secreto é ' + aleatoryNumber + '</h5><br>';
...
function initializeGame() {
    ...
    document.getElementById('infoGame').innerHTML = '<h3>Jogo iniciado, boa sorte!</h3>';
